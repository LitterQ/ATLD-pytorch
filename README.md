...
sh ./fs_eval_aa_cifar10.sh   #for evaluation with the proposed IMT (ATLD) on AutoAttack(AA). 
                             #Note the printed accuracy from AA's codes is just for ATLD-, 
                             #the printed accuracy from IMT's codes is for ATLD.
